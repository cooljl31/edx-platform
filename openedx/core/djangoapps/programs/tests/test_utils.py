...
class TestSupplementProgramData(ProgramsApiConfigMixin, ModuleStoreTestCase):
    ...
    @ddt.unpack
    def test_student_enrollment_status(self, is_enrolled, enrolled_mode, is_upgrade_required):
        ...
        self._assert_supplemented(data, is_enrolled=is_enrolled, is_upgrade_required=is_upgrade_required)
