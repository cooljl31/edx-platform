...
from openedx.core.djangoapps.theming.tests.test_util import with_comprehensive_theme, compile_sass
...
class TestComprehensiveThemeLMS(TestCase):
    ...
    def setUpClass(cls):
        ...
        compile_sass('lms', themes=['red-theme', 'test-theme'])
...
class TestComprehensiveThemeCMS(TestCase):
    ...
    def setUpClass(cls):
        ...
        """
        # Apply Comprehensive theme and compile sass assets.
        compile_sass('cms', themes=['red-theme', 'test-theme'])
